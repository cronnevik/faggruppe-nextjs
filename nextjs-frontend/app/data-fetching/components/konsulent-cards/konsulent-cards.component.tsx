                                ...
                                <div className="card-image">
                                    {
                                        ...
                                        <img src={konsulent.bildeURL} alt={`Profilbilde av ${konsulent.personalia.navn}`} />
                                    }
                                    
                                    {/*  {
                                        konsulent.bildeURL &&
                                        <Image height={200} width={175} src={konsulent.bildeURL} alt={`Profilbilde av ${konsulent.personalia.navn}`} />
                                    } */}
                                </div>
